...
3. Выполнить в терминале Visual Studio Code выполнить команды которые предоставляются в инструкции Github после создания локального репозитория в своем аккаунте.
